...
<body>
    ...
    <div id="msg" onclick="close_msg()">
        <div class='msg_txt' id="msg_t1">
            You should not have ZERO timer.
        </div>
        <div class='msg_txt' id="msg_t2">
            You should not have ZERO cycles.
        </div>
    </div>

    <div class="block_container">
        <div class="ins_text">Exercise I</div>
        <div class="timer" id="timer1"></div>
    </div>

    <div class="block_container">
        <div class="ins_text">Exercise II</div>
        <div class="timer" id="timer2"></div>
    </div>
    <div class="block_container">
        <div class="ins_text cycle_ins_text">Cycle</div>
        <div class="timer cycle_input">
            <div class="scrollport" id="cycle_scroll"></div>
        </div>
    </div>
    <div class='ios_style_switch'>
        <div class='ios_style_switch_text'>Sound</div>
    ...
    <div class="btbutton" onclick="timer_start()">START</div>
    <div class="btbutton" onclick="reset()">RESET</div>
